    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col items-center gap-3">
        <button
          ...
          disabled={uploading}
          className="group relative h-20 w-20 overflow-hidden rounded-full bg-teal-900 disabled:opacity-50"
        >
          {avatarUrl ? (
            // eslint-disable-next-line @next/next/no-img-element
            <img src={avatarUrl} alt="アバター" className="h-full w-full object-cover" />
          ) : (
            <span className="flex h-full w-full items-center justify-center text-lg font-medium text-teal-100">
