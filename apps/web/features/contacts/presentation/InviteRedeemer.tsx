  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3">
      <input
        ...
        maxLength={8}
        className="rounded-md border border-neutral-700 bg-neutral-950 px-3 py-2 font-mono tracking-widest text-neutral-100 outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500"
      />
